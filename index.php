...
.limiter{ width: 100%; 
padding: 0 25px;
} .limiter h1{ font-size: 20px; font-family: 'Bree Serif', serif; font-weight: 300; text-transform: uppercase; letter-spacing: 1px; margin-top: 50px; margin-bottom: 50px; }
...
.input{ border: 1.5px solid rgb(211, 211, 211); background-color: transparent; padding: 0 15px; transition: 0.5s; }
 ...
 select { width: 100%; height: 65px; margin: 15px 0; border-radius: 4px;		padding:0 20px;		font-size: 15px;		outline: none; font-family: 'Bree Serif', serif; }</style><body> <div class="limiter"> <h1>Inferno Hacking<h1><h1>SMS Bomber 2023 by @InfernoHacking</h1>

<form mehod='GET' action='otp.php'>
	
	<input type='text' name='mo' class='input' placeholder='Enter Number' required>
...
<div class="telegram"> <i class="fa fa-telegram" aria-hidden="true"></i> <a href="https://t.me/InfernoHacking">Join Our Telegram</a></div></div></body></html>